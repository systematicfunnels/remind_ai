...
function LoginFormContent() {
  ...
  const initialPlatform = searchParams.get('platform') as 'whatsapp' | 'telegram' | null;
  ...
  return (
    <div className="min-h-screen bg-[#020617] flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md">
        ...
        <Suspense fallback={
          <div className="bg-slate-900/50 border border-slate-800 p-8 md:p-12 rounded-[2.5rem] backdrop-blur-xl shadow-2xl flex items-center justify-center min-h-[400px]">
